...
public class CCSPPkgPolicy implements Serializable, Comparable<CCSPPkgPolicy>, Cloneable {
	...
	public CCSPPkgPolicy(){
	}
	
	public CCSPPkgPolicy(String name, int freeDay, int useDay, int renewFee, int reRegisterFee, int status, 
	...
	@Override
	public int compareTo(CCSPPkgPolicy o) {
