...
public class TEST_Read_xxx {
	
	// map chữ cái sang vị trí (A=0, B=1, ....AZ=51)
	static Hashtable<String, Integer> mapCharAndIndexColum = new Hashtable<String, Integer>();
	static {
		int index = 0;
		for(int i = 65; ; i++) {
			String s = ((char) i) + "";
			mapCharAndIndexColum.put(s, index);
		...
		for(int i = 65; ; i++) {
			String s = ((char) i) + "";
			mapCharAndIndexColum.put("A" + s, index);
