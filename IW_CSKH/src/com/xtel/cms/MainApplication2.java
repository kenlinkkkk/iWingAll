...
//@Title("CMMS")
//@Theme("liger")
@Widgetset ( "com.xtel.cms.MyAppWidgetset" )

public class MainApplication2 extends UI
{
    ...
    @VaadinServletConfiguration ( ui = MainApplication2.class , productionMode = false )
