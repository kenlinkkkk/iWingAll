...
public class ActionHis implements Serializable {
	...
	public static void main(String[] args) {
		/*ActionHis a = new ActionHis(id, msisdn, action, createdTime, fee, transId, note, channel, result, pkgCode, 
				cpid, expireTime, regdate, 
				subnote1, subnote2, subnote3, subnote4, subnote5, 
				expireint, activeint, 
				hisnote1, hisnote2, hisnote3);*/
	}
	
	public ActionHis(int id, String msisdn, String action, Date createdTime, int fee, String transId, 
			...
			String subnote5, int expireint, int activeint, String hisnote1, String hisnote2, 
			String hisnote3){
		this();
		if(createdTime == null){
