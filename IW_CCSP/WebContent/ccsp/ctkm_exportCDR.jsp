...
<%
    ...
    */
    ...
    out.print(dangkyngayquatraotay(transid, dayhomqua,folderPath, ngayhomqua, log, baseDAO));
...
<%!
    private static String dangkyngayquatraotay(String transid, Date dayhomqua,String folderPath, String ngayhomqua, Logger log, BaseDAO baseDAO){
        ...
        if(beginctkm.getTime()<=dayhomqua.getTime()&&dayhomqua.getTime()<=endctkm.getTime()){
            String where=" where report_time>='20200605' and status_exportcdr=0 and category='ikv1' and created_time>='"+DateToStringByFormatConfig(beginctkm,"yyyyMMdd")+"' and created_time<='"+DateToStringByFormatConfig(endctkm,"yyyyMMdd")+"' + interval 1 day";
        ...
        //CDR cộng tiền
        String where=" where a.report_time>='20200309' and a.status_exporttopup=0 and a.category='ikv1' and b.status=2 and a.created_time>='"+DateToStringByFormatConfig(beginctkm,"yyyyMMdd")+"' and a.created_time<='"+DateToStringByFormatConfig(endctkm,"yyyyMMdd")+"' + interval 1 day";
